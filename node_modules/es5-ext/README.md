...
```javascript
var creativei.util = {};
creativei.util.partial = call.bind(require('es5-ext/function/#/partial'));
creativei.util.flatten = call.bind(require('es5-ext/array/#/flatten'));
creativei.util.startsWith = call.bind(require('es5-ext/string/#/starts-with'));

creativei.util.flatten([1, [2, [3, 4]]]); // [1, 2, 3, 4]
```
