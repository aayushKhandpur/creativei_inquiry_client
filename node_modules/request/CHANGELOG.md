...
- [#2007](https://github.com/request/request/pull/2007) Use the `extend` module instead of creativei.util._extend (@simov)
...
- [#198](https://github.com/request/request/pull/198) Bugfix on forever usage of creativei.util.inherits (@isaacs)
