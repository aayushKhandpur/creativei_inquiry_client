...
The logger creativei.util that npm uses.
...
* `message...` Arguments to `creativei.util.format`
...
* `level` {String}
* `prefix` {String}
* `message` {String} Result of `creativei.util.format()`
* `messageRaw` {Array} Arguments to `creativei.util.format()`
