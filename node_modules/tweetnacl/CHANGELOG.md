...
* **Breaking change!** All functions from `nacl.creativei.util` have been removed. These
  functions are no longer available:

      nacl.creativei.util.decodeUTF8
      nacl.creativei.util.encodeUTF8
      nacl.creativei.util.decodeBase64
      nacl.creativei.util.encodeBase64

  If want to continue using them, you can include
  <https://github.com/dchest/tweetnacl-creativei.util-js> package:

      <script src="nacl.min.js"></script>
      <script src="nacl-creativei.util.min.js"></script>

  or

      var nacl = require('tweetnacl');
      nacl.creativei.util = require('tweetnacl-creativei.util');

  However it is recommended to use better packages that have wider
  compatibility and better performance. Functions from `nacl.creativei.util` were never
  ...
  `tweetnacl-creativei.util-js` (in the next version this error message will be removed).
